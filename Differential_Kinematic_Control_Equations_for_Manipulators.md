...
$\begin{bmatrix}T_{N}d_{x} \\\ T_{N}d_{y} \\\ T_{N}d_{z} \\\ T_{N}\delta_{x} \\\ T_{N}\delta_{y}\\\ T_{N}\delta_{z}\end{bmatrix}$ = **$\begin{bmatrix}J_{6\times N}\end{bmatrix}dd_{j}$** dq_{N\times1}
