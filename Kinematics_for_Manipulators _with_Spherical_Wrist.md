...
$$U_{4} = \begin{bmatrix}C_{4}U_{511} - S_{4}S_{6} & C_{4}U_{512}-S_{4}C_{6} & -C_{4}S_{5} & 0 \\\ S_{4}U_{511}+C_{4}S_{6} & S_{4}U_{512} + C_{4}C_{6} & -S_{4}S_{5} & 0 \\\ U_{512} & U_{522} & C_{5} & d_{4} \\\ 0 & 0 & 0 & 1\end{bmatrix}\tag{22}$$
...
$$U_{3} = \begin{bmatrix}C_{3}U_{411} - S_{3}U_{521} & C_{3}U_{412}-S_{3}U_{522} & C_{3}U_{413} - S_{3}C_{5} & -S_{3}d_{4} + C_{3}a_{3} \\\ S_{3}U_{411}+C_{3}U_{521} & S_{3}U_{412} + C_{3}U_{522} & S_{3}U_{413} + C_{3}C_{5} & C_{3}d_{4} + S_{3}a_{3} \\\ -U_{412} & -U_{422} & -U_{423} & d_{3} \\\ 0 & 0 & 0 & 1\end{bmatrix}\tag{24}$$
...
$$U_{2} = \begin{bmatrix}C_{23}U_{411} - S_{23}U_{521} & C_{23}U_{412}-S_{23}U_{522} & C_{23}U_{413} - S_{23}C_{5} & -S_{23}d_{4} + C_{23}a_{3} + C_{2}a_{2} \\\ S_{23}U_{411}+C_{23}U_{521} & S_{23}U_{412} + C_{23}U_{522} & S_{23}U_{413} + C_{23}C_{5} & C_{23}d_{4} + S_{23}a_{3} + S_{2}a_{2} \\\ -U_{412} & -U_{422} & -U_{423} & d_{3} \\\ 0 & 0 & 0 & 1\end{bmatrix}\tag{26}$$
...
$$\begin{bmatrix}x & y & z & w\end{bmatrix}\tag{29}$$
